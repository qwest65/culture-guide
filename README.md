...
### [⬇️ Скачать APK 0.9.0](https://github.com/qwest65/culture-guide/releases/download/v0.9.0/CultureGuide-v0.9.0.apk)
...
|---|---|
| `main` | тесты и сборка, затем GitHub Release `v<версия>` с единственным файлом `CultureGuide-v<версия>.apk` и `SHA256SUMS.txt`, помеченный как Latest |
| `claude/**` | тесты и сборка, затем пред-релиз `preview` (не становится Latest) |

Страница последней стабильной версии: https://github.com/qwest65/culture-guide/releases/latest. Имя файла содержит номер версии, поэтому при выпуске новой версии обновите ссылки «Скачать APK» в начале README и в разделе «Установка на телефон».
